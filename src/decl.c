...
#ifdef TOURIST
# ifdef JFIGHTER
const char NEARDATA *pl_classes = "ABCDEFGHIJKLMNPRSTUVW";
# else
const char NEARDATA *pl_classes = "ABCDEFGHIKLMNPRSTUVW";
# endif
#else
# ifdef JFIGHTER
const char NEARDATA *pl_classes = "ABCDEFGHIJKLMNPRSUVW";
# else
const char NEARDATA *pl_classes = "ABCDEFGHIKLMNPRSUVW";
# endif
#endif
