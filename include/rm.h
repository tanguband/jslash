...
#define S_vbeam		62	/* The 4 zap beam symbols.  Do NOT separate. */
#define S_hbeam		63	/* To change order or add, see function     */
#define S_lslant	64	/* zapdir_to_glyph() in display.c.	    */
#define S_rslant	65
#define S_digbeam	66	/* dig beam symbol */
#define S_flashbeam	67	/* camera flash symbol */
#define S_boomleft	68	/* thrown boomerang, open left, e.g ')'    */
#define S_boomright	69	/* thrown boomerand, open right, e.g. '('  */
#define S_ss1		70	/* 4 magic shield glyphs */
#define S_ss2		71
#define S_ss3		72
#define S_ss4		73
...
#define S_sw_tl		74	/* swallow top left [1]			*/
#define S_sw_tc		75	/* swallow top center [2]	Order:	*/
#define S_sw_tr		76	/* swallow top right [3]		*/
#define S_sw_ml		77	/* swallow middle left [4]	1 2 3	*/
#define S_sw_mr		78	/* swallow middle right [6]	4 5 6	*/
#define S_sw_bl		79	/* swallow bottom left [7]	7 8 9	*/
#define S_sw_bc		80	/* swallow bottom center [8]		*/
#define S_sw_br		81	/* swallow bottom right [9]		*/

#define S_explode1	82	/* explosion top left			*/
#define S_explode2	83	/* explosion top center			*/
#define S_explode3	84	/* explosion top right		 Ex.	*/
#define S_explode4	85	/* explosion middle left		*/
#define S_explode5	86	/* explosion middle center	 /-\	*/
#define S_explode6	87	/* explosion middle right	 |@|	*/
#define S_explode7	88	/* explosion bottom left	 \-/	*/
#define S_explode8	89	/* explosion bottom center		*/
#define S_explode9	90	/* explosion bottom right		*/

/* end effects */

#define MAXPCHARS	91	/* maximum number of mapped characters */
