...
#define SUMMON_UNDEAD   (LAST_PROP+7)
#define DEATH_GAZE      (LAST_PROP+8)
/* STEPHEN WHITE'S NEW CODE */
#define LIGHT_AREA      (LAST_PROP+9)
#define PROT_POLY       (LAST_PROP+10)
#define SUMMON_FIRE_ELEMENTAL           (LAST_PROP+11)
#define SUMMON_WATER_ELEMENTAL          (LAST_PROP+12)
#define CREATE_PORTAL   (LAST_PROP+13)
