 ...
 */
#ifndef MSDOS		/* usually not unix-ish directory */
# ifndef HACKDIR
#  define HACKDIR "/usr/local/jslashdir"
# endif
#endif
...
#define CROWN		/* Crowned by your God */
/* dungeon levels */
...
#define JFIGHTER               /* Sailor Fighter with sailor blouse */
...
/* #define BORG		/* Nethack borg (cannot use on unix) */
