...
#ifdef OVLB
#ifdef JFIGHTER
const char *classes = "ABCDEFGHIJKLMNPRSTUVW";
#else
const char *classes = "ABCDEFGHIKLMNPRSTUVW";
#endif
#else
...
#endif
		hname = "JSlash";      /* used for syntax messages */
...
/*JP		pline("Hello %s, welcome back to NetHack!", plname);*/
		pline("ようこそ %s, またSlashの世界へ！", plname);
